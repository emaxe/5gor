...
const GOPNIK_QUOTES = [
  ...
  "Пятёрочку на бутер...",
  "Чё, братан, по-быстрому?",
  "На районе всё спокойно.",
  "Слышь, мелочи не звякнет?",
  "С пацанами на лавочке сидим..."
];

// Бабушка (grandma)
const GRANDMA_QUOTES = [
  "Ох, спина моя...",
  "Молодёжь нынче гоняет...",
  "Дай дорогу бабушке!",
  "В поликлинику бы без очереди попасть...",
  "Опять цены на рынке подняли...",
  "Травки от давления надо купить...",
  "Эх, внучатам бы пирожков напечь..."
];

// Бегун (runner)
const RUNNER_QUOTES = [
  "Ноги — моё всё!",
  "Опоздаю на электричку!",
  "Ещё круг и домой...",
  "Главное — темп держать!",
  "Утренняя пробежка — заряд на день!",
  "Дыхание ровное, пульс в норме...",
  "Вокруг Машука бы пробежаться..."
];

// Студент (student)
const STUDENT_QUOTES = [
  "Сессия скоро...",
  "На пары бегу, препод злой...",
  "Курить и учиться — оба вредно...",
  "Где бы конспект по матану достать?",
  "Стипуху бы поскорее выплатили...",
  "Опять в общаге до утра сидели...",
  "Только бы зачёт автоматом поставили..."
];

// Бизнесмен (businessman)
const BUSINESSMAN_QUOTES = [
  "У меня переговоры!",
  "Время — деньги!",
  "Созвон через пять минут...",
  "Акции проверяю, секунду...",
  "Надо сделку закрыть до вечера...",
  "Вай, пробки срывают все встречи!",
  "Контракт горит, надо поторопиться..."
];

// Турист (tourist)
const TOURIST_QUOTES = [
  "А где тут нарзан?",
  "Как пройти к Провалу?",
  "Красивый у вас Пятигорск!",
  "Надо сфотографироваться у орла!",
  "Воздух здесь невероятный!",
  "А где тут дача Эльзы?",
  "Вай, какой вид на Бештау открывается!"
];
...
const CHILD_QUOTES = [
  ...
  "Хочу мороженое!",
  "А это что за птица?",
  "Смотри, какой голубь смешной!",
  "А мы на карусели пойдём?",
  "Мам, купи шарик!",
  "Ура, мы гуляем в парке!"
];
...
const CURSE_GOPNIK_QUOTES = [
  "Куда прёшь, олень?!",
  "Ты чё, рамсы попутал?!",
  "Слышь, ты кого подрезал?!",
  "Ща фары разобью, джигит!",
  "Ты чё, страх потерял?!",
  "Эй, вылезай из ведра, поговорим!",
  "Слышь, колымага, ща без бампера останешься!"
];

const CURSE_GRANDMA_QUOTES = [
  "Ироды! Чуть бабку не сбили!",
  "Куда летишь, окаянный?!",
  "Тьфу на тебя, душегуб окаянный!",
  "В полицию на тебя заявлю, бандит!",
  "Чтоб тебе пусто было, лихач!",
  "Совсем стариков не уважают, ирод!",
  "Ослеп, что ли, старую не видишь?!"
];

const CURSE_RUNNER_QUOTES = [
  "Мешаешь пробежке!",
  "Куда несёшься, тут беговая дорожка?!",
  "Сбил мне весь темп!",
  "Смотри под колёса, бегунов не видишь?!",
  "Чуть кроссовки не отдавил!",
  "Эй, притормози, я на рекорд иду!",
  "Глаза разуй, тут люди тренируются!"
];

const CURSE_STUDENT_QUOTES = [
  "Осторожнее, я конспект нёс!",
  "Ты что творишь, у меня зачёт сегодня?!",
  "Чуть зачётку не растоптал!",
  "Куда летишь, я на пару опаздываю?!",
  "Водить научись, двоечник!",
  "Смотри куда едешь, права купил?!",
  "Эй, шумахер, стипендию мою оплатишь?!"
];

const CURSE_BUSINESSMAN_QUOTES = [
  "Вы что, по пешеходам ездите?!",
  "У меня костюм дороже твоей машины!",
  "Я в суд на тебя подам!",
  "Ты мне встречу чуть не сорвал!",
  "Куда прёшь, баран на колёсах?!",
  "Мой адвокат с тобой свяжется!",
  "Ты хоть знаешь, сколько стоит моё время?!"
];

const CURSE_TOURIST_QUOTES = [
  "Осторожно, турист!",
  "Это что за курортный сервис такой?!",
  "Чуть фотоаппарат не разбил!",
  "Беспредел на курорте!",
  "Вы куда гоните, тут отдыхающие!",
  "Полиция, меня чуть не сбили!",
  "Я жалобу в министерство туризма напишу!"
];

const CURSE_CHILD_QUOTES = [
  "Ой, дядя плохой!",
  "Мама, меня чуть не задавили!",
  "Дядя, ты почему такой злой?!",
  "Ой, машинка на меня едет!",
  "Мама, спаси, он не умеет рулить!",
  "Дядя на бибике, не дави меня!",
  "Ай, я маме всё расскажу!"
];
...
export class PedestrianManager {
  ...
  _idlePool(arch) {
    switch (arch) {
      ...
      case 'grandma': return GRANDMA_QUOTES;
      ...
      case 'gopnik': return GOPNIK_QUOTES;
      case 'runner': return RUNNER_QUOTES;
      case 'student': return STUDENT_QUOTES;
      case 'businessman': return BUSINESSMAN_QUOTES;
      case 'tourist': return TOURIST_QUOTES;
      case 'child': return CHILD_QUOTES;
  ...
  _cursePool(arch) {
    switch (arch) {
      ...
      case 'grandma': return CURSE_GRANDMA_QUOTES;
      ...
      case 'gopnik': return CURSE_GOPNIK_QUOTES;
      case 'runner': return CURSE_RUNNER_QUOTES;
      case 'student': return CURSE_STUDENT_QUOTES;
      case 'businessman': return CURSE_BUSINESSMAN_QUOTES;
      case 'tourist': return CURSE_TOURIST_QUOTES;
      case 'child': return CURSE_CHILD_QUOTES;
